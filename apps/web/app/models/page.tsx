...
export default async function MediaModelsPage({
  ...
  return (
    <StudioAdminShell
      ...
      title="Models"
      description="Choose a Studio model, then manage everything tied to that model in one place: capabilities, output limits, prompt helper instructions, and Nano presets."
    >
      <MediaModelsConsole
