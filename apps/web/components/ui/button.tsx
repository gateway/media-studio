...
export function buttonClassName({
  ...
  const compactClassName =
    size === "compact"
      ? appearance === "admin"
        ? variant === "primary"
          ? "w-auto px-4 py-[0.45rem] text-[0.71rem] uppercase tracking-[0.12em]"
          : "w-auto px-4 py-[0.45rem]"
