...
def _kernel_instruction() -> str:
    ...
    return (
        ...
        "the standard recipe graph. For other graph building, inspect only the workflow, node types, or schemas "
        "that are genuinely unresolved before using propose_graph_operations. Use validate_current_workflow for "
