...
Graph changes use only these operation names: `add_node`, `set_node_field`, `set_node_title`, `set_execution_mode`, `add_note`, `connect_nodes`, and `group_nodes`.
