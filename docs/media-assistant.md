...
- Ordinary p95 latency, token volume, provider-step distribution, and the incomplete D1–V3 human browser matrix still exceed the release boundary. The G1–G3/P5/R3–R4 fixture mismatches and exact post-restart five-turn story recall are resolved; reference analysis remained within its separate 60-second p95 ceiling in all three Ticket 09 samples.
